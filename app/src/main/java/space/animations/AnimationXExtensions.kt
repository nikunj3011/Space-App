package space.animations

import android.animation.Animator
import android.animation.AnimatorSet
import android.view.View
import space.animations.Attention.ATTENTION
import space.animations.Attention.ATTENTION_BOUNCE
import space.animations.Attention.ATTENTION_FLASH
import space.animations.Attention.ATTENTION_PULSE
import space.animations.Attention.ATTENTION_RUBERBAND
import space.animations.Attention.ATTENTION_SHAKE
import space.animations.Attention.ATTENTION_STAND_UP
import space.animations.Attention.ATTENTION_SWING
import space.animations.Attention.ATTENTION_TA_DA
import space.animations.Attention.ATTENTION_WAVE
import space.animations.Attention.ATTENTION_WOBBLE
import space.animations.Bounce.BOUNCE
import space.animations.Bounce.BOUNCE_IN
import space.animations.Bounce.BOUNCE_IN_DOWN
import space.animations.Bounce.BOUNCE_IN_LEFT
import space.animations.Bounce.BOUNCE_IN_RIGHT
import space.animations.Bounce.BOUNCE_IN_UP
import space.animations.Fade.FADE
import space.animations.Fade.FADE_IN
import space.animations.Fade.FADE_IN_DOWN
import space.animations.Fade.FADE_IN_LEFT
import space.animations.Fade.FADE_IN_RIGHT
import space.animations.Fade.FADE_IN_UP
import space.animations.Fade.FADE_OUT
import space.animations.Fade.FADE_OUT_DOWN
import space.animations.Fade.FADE_OUT_LEFT
import space.animations.Fade.FADE_OUT_RIGHT
import space.animations.Fade.FADE_OUT_UP
import space.animations.Flip.FLIP
import space.animations.Flip.FLIP_IN_X
import space.animations.Flip.FLIP_IN_Y
import space.animations.Flip.FLIP_OUT_X
import space.animations.Flip.FLIP_OUT_Y
import space.animations.Rotate.ROTATE
import space.animations.Rotate.ROTATE_IN
import space.animations.Rotate.ROTATE_IN_DOWN_LEFT
import space.animations.Rotate.ROTATE_IN_DOWN_RIGHT
import space.animations.Rotate.ROTATE_IN_UP_LEFT
import space.animations.Rotate.ROTATE_IN_UP_RIGHT
import space.animations.Rotate.ROTATE_OUT
import space.animations.Rotate.ROTATE_OUT_DOWN_LEFT
import space.animations.Rotate.ROTATE_OUT_DOWN_RIGHT
import space.animations.Rotate.ROTATE_OUT_UP_LEFT
import space.animations.Rotate.ROTATE_OUT_UP_RIGHT
import space.animations.Slide.SLIDE
import space.animations.Slide.SLIDE_IN_DOWN
import space.animations.Slide.SLIDE_IN_LEFT
import space.animations.Slide.SLIDE_IN_RIGHT
import space.animations.Slide.SLIDE_IN_UP
import space.animations.Slide.SLIDE_OUT_DOWN
import space.animations.Slide.SLIDE_OUT_LEFT
import space.animations.Slide.SLIDE_OUT_RIGHT
import space.animations.Slide.SLIDE_OUT_UP
import space.animations.Zoom.ZOOM
import space.animations.Zoom.ZOOM_IN
import space.animations.Zoom.ZOOM_IN_DOWN
import space.animations.Zoom.ZOOM_IN_LEFT
import space.animations.Zoom.ZOOM_IN_RIGHT
import space.animations.Zoom.ZOOM_IN_UP
import space.animations.Zoom.ZOOM_OUT
import space.animations.Zoom.ZOOM_OUT_DOWN
import space.animations.Zoom.ZOOM_OUT_LEFT
import space.animations.Zoom.ZOOM_OUT_RIGHT
import space.animations.Zoom.ZOOM_OUT_UP
